...
function init(){
    ...
    ctx.fillRect(4*unit,9*unit,8*unit,unit);
    ctx.fillRect(3*unit,10*unit,10*unit,unit);
    ...
    ctx.fillRect(2*unit,11*unit,12*unit,unit);
        ...
        ctx.fillRect(4*unit,4*unit,3*unit,unit);
        ctx.fillRect(5*unit,5*unit,unit,2*unit);
